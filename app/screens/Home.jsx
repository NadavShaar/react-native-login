    ...
    return (
        <SafeAreaView style={styles.wrapper}>
            ...
            <Text style={styles.introText}>
                Welcome <Text style={{color: "#ffc800"}}>{user.username}</Text>
            </Text>
            <TouchableOpacity onPress={logout} style={{position: 'absolute', right: 40, top: 100}}>
                <SimpleLineIcons style={{color: '#fff'}} name="logout" size={24} color="black" />
            </TouchableOpacity>
        </SafeAreaView>
    )
}
